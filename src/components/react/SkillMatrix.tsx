...
const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    category: "前端框架",
    level: 82,
    desc: "本站点的构建核心：React 孤岛集成（client:visible 按需激活），默认零 JS 输出。",
  },
  {
    id: "python",
    name: "Python",
  ...
  },
  {
    ...
    category: "编程语言",
    level: 75,
    desc: "Java 17：AI 简历匹配平台（Spring Boot 3.5）与毕业设计（Spring + MyBatis）的实现语言。",
  },
  {
    id: "spring",
    name: "Spring + MyBatis",
    category: "工具链",
    level: 70,
    desc: "简历匹配平台：Spring Boot 3.5 + Data JPA + Validation；毕业设计：全注解 Java Config（无 XML）、REST API、参数校验与 RBAC 权限，MyBatis 负责数据访问。",
  },
  {
    id: "redis",
    name: "Redis",
    category: "工具链",
    level: 60,
    desc: "简历匹配平台：JD 内容哈希缓存 + 每 IP 固定窗口限流（429）；Redis 不可用时自动降级 Caffeine 内存缓存，接口语义一致。",
  },
  {
    id: "docker",
    name: "Docker",
    category: "工具链",
    level: 55,
    desc: "简历匹配平台：Dockerfile 多阶段构建（Maven 构建 → JRE 运行）+ docker-compose 编排 app/MySQL/Redis。",
  },
  {
    id: "mysql",
    name: "MySQL",
